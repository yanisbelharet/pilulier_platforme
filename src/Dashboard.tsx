                      ...
                      <div className="w-full bg-slate-50 border border-slate-200 rounded-xl p-6">
                        ...
                        <div className="border-t border-slate-200 pt-6">
                          ...
                          <div className="bg-emerald-50 border border-emerald-100 p-4 rounded-xl">
                            ...
                            <p className="text-xs text-emerald-600 mb-4">La synchronisation est automatique lors des nouvelles commandes (en temps réel). Vous pouvez aussi forcer la synchronisation manuellement pour les anciennes commandes non synchronisées.</p>
                            <button
                              onClick={handleSyncToSheets}
                              disabled={syncingSheets}
                              className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all disabled:opacity-70 shadow-sm"
                            >
                              <RefreshCw size={20} className={syncingSheets ? 'animate-spin' : ''} />
                              {syncingSheets ? 'Synchronisation en cours...' : 'Synchroniser les commandes manuellement'}
                            </button>
                          </div>
                        </div>
                      </div>
