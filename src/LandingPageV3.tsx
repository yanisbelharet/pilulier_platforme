  ...
  return (
    <div className="min-h-screen bg-slate-100 pb-24 font-sans text-slate-800" dir="rtl">
      <div className="max-w-2xl mx-auto bg-white shadow-2xl min-h-screen overflow-hidden flex flex-col">
        {/* 1. Image 1 */}
        <img src="/1_optimise.webp" alt="Product" className="w-full object-cover" />
        ...
        {/* 4. Images List */}
        <img src="/2_optimise.webp" alt="Product details" className="w-full object-cover" />
        <img src="/3_optimise.webp" alt="Product details" className="w-full object-cover mt-2" />
        <img src="/4_optimise.webp" alt="Product details" className="w-full object-cover mt-2" />
        <img src="/5_optimise.webp" alt="Product details" className="w-full object-cover mt-2" />
